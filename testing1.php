...
<nav class="navbar navbar-expand-lg">
		<a class="navbar-brand" href="#"><i class="fa fa-cube"></i></a>  		
	...
	<div id="navbarCollapse" class="collapse navbar-collapse">		
		<ul class="nav navbar-nav ml-auto">
			...
			<li class="nav-item dropdown dropdown-menu-right">
				<a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle user-action"><img src="https://www.tutorialrepublic.com/examples/images/avatar/3.jpg" alt="Avatar"> Antonio Moreno <b class="caret"></b></a>
